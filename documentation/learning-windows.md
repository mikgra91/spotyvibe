...
| **Over-request by +5** | `effective_batch_size = batch_size + 5` absorbs filtering losses. If GPT returns 15 tracks and 5 are duplicates, the caller still gets the requested 10. |
