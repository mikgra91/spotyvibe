...
def _finalise_cycle(bucket, bucket_name: str, state: dict) -> int:
    ...
    # The AI-artist blocklist is published separately by
    # build-tools/publish_ai_blocklist.py — it has its own manifest, cadence and
    # Cloud Run job, so a corpus cycle neither carries nor can clobber it.
